...
values ('b43134', 'Bronya Zaychik', '2001-5-4', 'Siberia', 'smt@fe', null, 'ceo', 'admin', '123456'),
	('m24234', 'Raiden Mei', '2001-3-6', 'Jp', 'ede@dw', null, 'ede', 'lecturer', '123456'),
	('t43924', 'Theresa Apocalypse', '1800-7-8', 'eu', 'wad@da', null, 'we@', 'faculty', '123456');
...
values ('000001d', 'General', 'meh'),
	('000123a', 'Natural Science' , 'meh'),
	('230012b', 'Social Science', 'meh'),
	('382322c', 'Physical Ed', 'meh');
